...
export default function QueuePanel({
  ...
  const { mutate: removeFromQueue, isPending: isRemoving } =
    useRemoveFromQueue();
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-arena-border flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-display text-lg text-arena-neon tracking-wide">
              QUEUE
            </h2>
            {queue.length > 0 && (
          ...
          {queueLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 gap-3 text-center px-6">
              ...
              <p className="text-muted-foreground text-xs">
                ...
                <span className="text-arena-neon font-semibold">+ Queue</span>{" "}
                button on any content.
              </p>
            </div>
          ) : (
