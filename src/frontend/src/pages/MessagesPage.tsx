      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          {profileLoading ? (
            ...
            <span
              className={`font-semibold text-sm truncate ${unreadCount > 0 ? "text-foreground" : "text-muted-foreground"}`}
            >
              {partnerName}
            </span>
          )}
        ...
        <div className="flex items-center justify-between gap-2 mt-0.5">
          ...
          >
            {lastMessage
              ? (lastMessage.sender.toString() === callerPrincipalStr
                  ? "You: "
                  : "") + lastMessage.content
              : "No messages yet"}
          </p>
        ...
        >
          {selectedPartnerPrincipal ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-6">
              ...
              <p className="text-sm text-muted-foreground">
                Choose a conversation from the list, or visit a user's profile
                to start a new one.
              </p>
            </div>
          )}
