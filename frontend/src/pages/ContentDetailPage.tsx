...
export default function ContentDetailPage() {
  ...
  const isOwner = identity && content
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-6 flex items-center gap-3 flex-wrap">
          ...
          >
            ...
            />
            {showComments ? 'Hide Comments' : `Comments (${content.comments.toString()})`}
          </Button>
          ...
          {nextContentId && (
            <div className="bg-arena-surface border border-arena-neon/20 rounded-lg p-3 flex items-center justify-between gap-3">
              <p className="text-xs text-muted-foreground">
                <span className="text-arena-neon font-semibold">Next in queue</span> — ready to play
              </p>
              <Button
