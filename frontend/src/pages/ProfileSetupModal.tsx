...
import { Loader2, Mic2, Camera, X } from 'lucide-react';
    ...
    <Dialog open={true}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-2">
          ...
          {/* Artist Name */}
          <div className="space-y-2">
            <Label htmlFor="setup-name" className="text-foreground font-semibold">
          ...
          {/* Bio (optional) */}
          <div className="space-y-2">
            <Label htmlFor="setup-bio" className="text-foreground font-semibold flex items-center gap-1.5">
              Bio
              <span className="text-xs font-normal text-muted-foreground">(optional)</span>
            </Label>
            <Textarea
